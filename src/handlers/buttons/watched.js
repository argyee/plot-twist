...
async function handleWatchedButton(interaction) {
    try {
        ...
        logger.debug("Watched button pressed", {
            movieId,
            userId,
        ...
        if (bullyMessage) {
            ...
            logger.debug("Watched action blocked by bullying system", {
                movieId,
                userId,
                user: interaction.user.tag,
            });
        ...
        if (alreadyWatched) {
            ...
            logger.debug("Removed movie from watched list", {
                movieId,
                userId,
                user: interaction.user.tag,
                watchedCount,
            ...
            logger.debug("Marked movie as watched", {
                movieId,
                movieTitle,
                movieYear,
                userId,
        ...
        logger.error("Error handling watched button", {
            error: error.message,
            stack: error.stack,
